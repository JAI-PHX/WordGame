...
public class Numbers {
    ...
    // Getter for randomNum. Updated to be static
    public static int getRandomNum() {

        return randomNum;
    }

    // This setter randomNum is now static
    public static void setRandomNum(int randomNum) {

        Numbers.randomNum = randomNum;
    }

    // Generate a random number between 0 and 100 and set the randomNum value. Updated to be static
